...
export default function ProfilePage() {
  ...
  const { user, isLoggedIn, passwordLogin, passwordRegister, logout, fetchMe } =
    useUserStore();
  ...
  const menuItems = [
    { icon: "🎁", label: "开盲盒", path: "/pages/blindbox/index" },
    ...(user?.role === "ADMIN"
      ? [{ icon: "🍽️", label: "菜品管理", path: "/pages/dish-manage/index" }]
      : []),
        ...
        {isLoggedIn && user ? (
          ...
          <>
            ...
            <View className="user-info">
              ...
              {user.role === "ADMIN" && (
                <Text className="role-badge">管理员</Text>
              )}
            </View>
          </>
        ) : (
